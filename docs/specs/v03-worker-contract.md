...
> **本文档不是决策文件。** 决策在 **ADR-0007《写入通道》（PR #61，待合并）**；本文是把那份 ADR 翻译成「打开编辑器就能照着写」的实现契约，外加 ADR 没写、但 #19 一开工就必须回答的那些细节。
>
> **ADR-0007 状态是 Proposed，PR #61 尚未合并。** 本文凡引用它的地方一律写成「ADR-0007（PR #61，待合并）§N」，并给出章节号。**PR #61 的最终形态若与本文冲突，以 ADR 为准，本文跟进修订。**
>
