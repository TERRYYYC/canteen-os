...
const evidenceRepo="/Users/terry/Desktop/coding/chief-master/chief-master/canteen-os-team-pages";const head="5049f0a47c76c4149a91a288a6a9b6edf279b1ea";
...
await writeFile(join(web,'copy-controls.js'),await readFile('/private/tmp/canteen-q-t08-browser-author/copy-controls.js'));
html=html.replace('</body>','<script type="module" src="/copy-controls.js"></script></body>');
...
const metadata={head,packagesTree,node:process.version,nodePath:process.execPath,fixedAt,fixtureRevision:fixture.revision,fixtureRoot:fixture.root,root,sourceIntegrity,
  boundary:'D author browser: actual main, C and Worker; fixed Q FakeRepo ad54d4f; native clipboard with explicit failure/hold controls; no live publish or rollback',qFixtureHead:'ad54d4ff31f977624e1605e883d3c2286a50358b',
  htmlChanges:['fixed-date/public-test-token bootstrap','remove external font links for offline isolation','D visible native/failure/hold clipboard and metadata controls'],producer:{blocking:0,warnings:fixture.built.issues.length}};
