...
const panel=document.createElement('aside');panel.id='review-panel';panel.innerHTML='<strong>INDEPENDENT D REVIEW TEST · actual application/main/PWA · simulated API only</strong><div id="review-controls"></div><pre id="review-output"></pre>';
