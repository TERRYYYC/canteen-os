...
await build({root,configFile:root+'/vite.config.ts',plugins:[{name:'observe-only-route-graph',async writeBundle(_options,bundle){
 ...
 await writeFile(output+'/bundle-attribution.json',JSON.stringify(chunks,null,2));
