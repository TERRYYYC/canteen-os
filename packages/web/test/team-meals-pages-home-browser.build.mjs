...
const injected={
 '../../api/client':'export const getApi=()=>{if(globalThis.__homeBrowser.legacy)return globalThis.__homeBrowser.legacy;throw new Error("D home fixture forbids legacy API reads");};',
