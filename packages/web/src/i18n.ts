...
const DICT = {
  ...
  "page.teamMenu": { uk: "Харчування", zh: "用餐安排", en: "Meals" },
  ...
  "drawer.menu.view": { uk: "Переглянути меню", zh: "查看菜单", en: "View menu" },
  "drawer.teamPlan": { uk: "Планування меню", zh: "排每天的菜", en: "Plan meals" },
  "drawer.plan.empty": { uk: "Немає доступного плану", zh: "暂无可打开的计划", en: "No plan available" },
  "drawer.plan.unavailable": { uk: "Дані плану ще недоступні", zh: "计划资料尚未就绪", en: "Plan data is not available yet" },
  ...
  "update.checkTitle": { uk: "Оновлення застосунку", zh: "更新应用", en: "Update application" },
  "update.continue": { uk: "Продовжити роботу", zh: "继续编辑，稍后更新", en: "Continue editing, update later" },
  "update.dirty": { uk: "Є незбережені зміни. Оновлення видалить перелічені локальні зміни.", zh: "有未保存的更改。更新将丢弃下面列出的本地更改。", en: "There are unsaved changes. Updating will discard the local changes listed below." },
